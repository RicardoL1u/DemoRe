...
# dataset list
dataset_name_list = ['ACE05', 'CASIE']

datapath = 'ALL_DATASETS_NEW/EE'
# build embedding
for dataset_name in dataset_name_list:
    ...
    with open(os.path.join(datapath, dataset_name + '/train_entity_only_embs.npy'), 'wb') as f:
        np.save(f, entity_only_embs)